...
public class Wifi extends Service {
    ...
    public void read_data() {
        ...
        if (c.getCount() != 0) {
            c.moveToFirst();
            do {
                time_start = c.getString(0).trim();
                time_end = c.getString(1).trim();
                bluetooth = c.getString(2).trim();
                battery = c.getString(3).trim();
                user_wifi_state = c.getInt(4);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
...

        {
            ...
            final WifiManager wifiManager = (WifiManager) Wifi.this.getSystemService(Context.WIFI_SERVICE);
            ...
            new Handler().postDelayed(new Runnable() {
                                          ...
                                          public void run() {
                                              ...
                                              //---------------------------------Trigger Check------------------------------
                                              if ((user_wifi_state == check_state || user_wifi_state == sys_Wifi_Enabled) && compare_time(user_hour_start, user_hour_end, user_minute_start, user_minute_end
                                                      , sys_hour_start, sys_minute_start)
                                                  ...
                                                  //Toastd.makeText(Wifi.this, "Wifi is connected", //Toastd.LENGTH_SHORT).show();*/
                                                  createNotification(ssid, mac);
                                                 /* //Toastd.makeText(Wifi.this, "You are connected to SSID: " + ssid + "Mac: " + mac, //Toastd.LENGTH_SHORT).show();
*/
                                                  //--------------------------------Perform actions--------------------------
                                                  ...
                                                  if (c.getCount() != 0) {
                                                      ...
                                                      do {
                                                              ...
                                                              if (samsung_music == null) {   //Checks for foodpanda installed or not
                                                                  ...
                                                                  if (play_music == null) {
                                                                      ...
                                                                      if (gaana == null) {  /*Rediercting to Playstore to install the application*/
                                                                         ...
                                                                         /* //Toastd .makeText(Wifi.this, response, //Toastd.LENGTH_SHORT).show();
                                                                         */
                                                          ...
                                                          if (!temp.equals("dnd")) {
                                                              ...
                                                              startActivity(timer);
                                                              //Toastd.makeText(Wifi.this, "Timer for " + minutes + " set Boss !! Brace yourself", //Toastd.LENGTH_SHORT).show();
                                                          ...
                                                          if (!temp.equals("dnd")) {
                                                              ...
                                                              //Toastd.makeText(Wifi.this, "Alarm Set Boss  ....", //Toastd.LENGTH_SHORT).show();
                                                              if (hour == 24 || hour > 24) {
                                                                  //Toastd.makeText(Wifi.this, "It seems the Hours are Incorrect", //Toastd.LENGTH_SHORT).show();
                                                              }
                                                              if (minutes > 60) {
                                                                  //Toastd.makeText(Wifi.this, "Apparently Earth only considers 60 minutes !! ", //Toastd.LENGTH_SHORT).show();
                                                              }
                                                              startActivity(i);
                                                          }
                                                          ...
                                                          if (!temp.equals("dnd")) {
                                                              ...
                                                              NotificationManager notificationManager =
                                                                      (NotificationManager) Wifi.this.getSystemService(Context.NOTIFICATION_SERVICE);
                                                  ...
                                                  //Toastd.makeText(Wifi.this, "Wifi is Disabled", //Toastd.LENGTH_SHORT).show();
